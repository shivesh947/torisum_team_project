   ...
   myfunc(val)
    ...
    render()
    {
       /* let city=this.props.location.state.products.filter((event,index)=>{
        ...
        return (
           <div>          
           <Nav1 datanav={this.props.location.state.datapass4} statedata={this.props.location.state.statedata}/>
             {this.myfunc(this.props.location.state.datapass4.products)}
           </div>
